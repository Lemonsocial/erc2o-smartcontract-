...
contract ERC20 is IERC20, Ownable, Pausable {
    ...
    address _Team,
    address _Development_and_marketing,
    ...
    ) public
    {
        ...
        // _balances[msg.sender] = totalSupply;
         ...
         Team = _Team ;
         Development_and_marketing = _Development_and_marketing;
         Private_sale = _Private_sale;
         Airdrop = _Airdrop;
         advisory = _advisory;
        _balances[investorAddress] = 85000000000000000000000000;
        _balances[Team] =  95000000000000000000000000;
        _balances[CommunityEcosystem] =  220000000000000000000000000;
        _balances[Development_and_marketing] =  215000000000000000000000000;
        _balances[Private_sale] =  285000000000000000000000000;
         _balances[Airdrop] =  35000000000000000000000000;
         _balances[advisory] = 20000000000000000000000000;
